...
if { [string compare [lindex $argv 1] "Cubic"] == 0 } {

	set sourceAlg Cubic;
} elseif { [string compare [lindex $argv 1] "Vegas"] == 0 } {
...
proc finish {} {
		global ns enableNAM enableTrace namfile tracefile mytracefile throughputfile
		$ns flush-trace
		close $mytracefile
