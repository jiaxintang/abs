set NUM_QUEUE 4;	#4
#set NUM_QUEUE 1;
#set NODES_PER_QUEUE 10;	#10
set NUM_FLOWS_IN_RTT(0) 10;
set NUM_FLOWS_IN_RTT(1) 10;
set NUM_FLOWS_IN_RTT(2) 10;
set NUM_FLOWS_IN_RTT(3) 10;
set N 0;
for {set i 0} {$i < 4} {incr i} {
	set N [expr $N+$NUM_FLOWS_IN_RTT($i)];
}
...
for {set i 0} {$i < 4} {incr i} {
	...
	for {set j 0} {$j < $NUM_FLOWS_IN_RTT($i)} {incr j} {
		set rtts($node_counter) [expr $base_rtt($i)];
		incr node_counter;
	}
}
...
Agent/TCP set minrto_ 0.4 ; # minRTO = 200ms
